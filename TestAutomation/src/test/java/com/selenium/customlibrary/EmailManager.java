...
final static Logger logger = Logger.getLogger(EmailManager.class);
    ...
    {       
        String emailMsgBody = "Test email by Risalat JavaMail API example. "
        + "<br><br> Regards, <br>Training Admin<br>";       
         
        setToAddress("sujinisivakumar@gmail.com,sujinisivakumar@gmail.com");        
        sendEmail("smtp.gmail.com", "587", "sujinisivakumar@gmail.com", 
                "vikru$68343", "Automated Java Email for Selenium", emailMsgBody,
                attachmentFiles);
    }
